...
I recently wrapped up Sprint 2 at [PI Lab](https://paaa.ai/). Sprint 2 was a deep dive into RAG with plenty of hands-on practice, and along the way a fair number of things left me wanting to dig deeper. This post pulls together what I learned in the sprint and what I went on to study on my own afterward.
...
[PI Lab](https://paaa.ai/) runs everything as pair programming. For this Sprint 2 RAG work, the three of us went through it together — looking things up whenever a question came up, explaining and researching for each other where our understanding was thin. It was genuinely great to fill in even the parts I'd have missed on my own.
