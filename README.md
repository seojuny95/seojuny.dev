...
The site itself is the real evidence of how I actually build, and design modern web.
...
A file-based MDX blog, statically generated and deployed on Vercel. Bilingual (Korean / English).

- **Next.js 16** (App Router) · **React 19** · **TypeScript**
- **Tailwind CSS v4** (CSS-first)
- **MDX** content with KaTeX math and Shiki syntax highlighting
